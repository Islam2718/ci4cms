...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">3rd Grid Settings</h1>
        ...
        <div class="col-xl-10 col-lg-10">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">3rd Grid</h6>                    
                </div>
                <!-- Card Body -->
                <div class="card-body">
<!-------------->
<table class="table table-bordered text-center" id="myTable">
  ...
  <tbody>
<?php $i=0; foreach($thirdgridArray as $carData) { $i++; ?>
    <tr>
      <th scope="row"><?= $i; ?></th>
      <td><?= $carData['title']; ?></td>
      <td><?= substr($carData['description'],0,40); ?></td>
      <td><?= $carData['meta_key']; ?></td>
      <td>
...
<div class="modal fade" id="upMod<?= $carData['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exmodalsoc"
    ...
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('third-grid-edit/'.$carData['id']); ?>" method="POST" enctype="multipart/form-data">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exmodalsoc">Update Grid</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <img src="<?= base_url('/uploads/'.$carData['thumb']); ?>" class="img img-responsive" style="width:100%; height:200px; ">
                    <input name="thumb" type="file" class="form-control" id="thumb" placeholder="Enter Title !" value="<?= $carData['title']; ?>" />
                    <input type="hidden" name="old_thumb" value="<?= $carData['thumb']; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="meta_key" type="text" class="form-control" id="meta_key" placeholder="Enter Meta Keyword"  value="<?= $carData['meta_key']; ?>" />
                </div> 
                <div class="form-group">
                    <label for="meta_des">Meta Description</label>
                    <textarea class="form-control" name="meta_des" rows="2" placeholder="Enter Meta Description !"><?= $carData['meta_des']; ?></textarea>
                </div>              
            </div>
...
<div class="modal fade" id="delModal<?= $carData['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                <a class="btn btn-danger" href="<?= base_url('third-grid-delete/'.$carData['id'].'/'.$carData['thumb']); ?>">Confirm</a>
            </div>
        </div>
    </div>
</div>    
...
<div class="modal fade" id="adModal" tabindex="-1" role="dialog" aria-labelledby="exmodalsoc"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('third-grid'); ?>" method="POST" enctype="multipart/form-data">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exmodalsoc">Add Grid</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
