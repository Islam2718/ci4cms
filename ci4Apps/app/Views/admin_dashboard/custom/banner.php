...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Banner Settings</h1>
...
<table class="table table-bordered text-center" id="myTable">
  ...
  <tbody>
<?php $i=0; foreach($bannerArray as $carData) { $i++; ?>
    <tr>
      <th scope="row"><?= $i; ?></th>
      <td><?= $carData['title']; ?></td>
...
<div class="modal fade" id="upMod<?= $carData['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exmodalsoc"
    ...
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('banner-edit/'.$carData['id']); ?>" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="delModal<?= $carData['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                <a class="btn btn-danger" href="<?= base_url('banner-delete/'.$carData['id'].'/'.$carData['thumb']); ?>">Confirm</a>
            </div>
        </div>
    </div>
</div>    
...
<div class="modal fade" id="adModal" tabindex="-1" role="dialog" aria-labelledby="exmodalsoc"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('banner-settings'); ?>" method="POST" enctype="multipart/form-data">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exmodalsoc">Add Banner</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
