                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Forget your password! don't worry Please submit your email and check email inbox or Spam box.</p>
                                    </div>
                                    <form class="user" action="<?= base_url('password-forgot'); ?>" method="POST">
