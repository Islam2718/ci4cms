...
function renderMiniCart() {
    ...
    if(!!localData && localData.length > 0) {
        ...
        cartItems += '<img src="../assets/img/empty-cart.png" text-center alt="cart img" class="cart-img-empty">';
    }
...
let suggestedProductSlider = $('.suggested-product-slider').owlCarousel({
    loop:false,
    margin:10,
    dot:true,
    autoplay:true,
